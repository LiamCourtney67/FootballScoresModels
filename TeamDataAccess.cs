...
namespace ConsoleApp1
{
    internal class TeamDataAccess
    {
        ...
        public TeamDataAccess(DatabaseConnection dbConnection)
        {
        ...
        /// <returns>A list of team instances from a league populated with data from the database.</returns>
        public List<Team> GetAllTeamsForLeagueFromDatabase(League league)
        {
            // Initialize a list to store and return the Team objects.
                    ...
                    using (MySqlCommand command = new MySqlCommand(selectQuery, connection))
                    {
                        ...
                        using (MySqlDataReader reader = command.ExecuteReader())
                        {
                            ...
                            while (reader.Read())
                            {
                                ...
                                // Validate the team object (i.e., ensure it has a valid ID) and add it to the list.
                                if (team.TeamID > 0)
                                {
                                    teams.Add(team);
                                }
